...
describe('LoginPage', () => {
  ...
  it('should_navigateToDashboard_when_loginSucceeds', async () => {
    ...
    vi.spyOn(authApi, 'adminLogin').mockResolvedValueOnce(mockResponse);
  ...
  it('should_showError_when_invalidCredentials', async () => {
    // Arrange
    vi.spyOn(authApi, 'adminLogin').mockRejectedValueOnce(
  ...
  it('should_disableButton_during_loading', async () => {
    ...
    vi.spyOn(authApi, 'adminLogin').mockImplementationOnce(
