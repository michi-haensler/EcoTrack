...
## 13. Empfehlung für nächste Iteration
1. Externe Keycloak-Integration (Token-Exchange, Admin API, Session-Invalidierung serverseitig gegen Keycloak).
2. Testcontainers-basierte Integrationsumgebung (DB + Keycloak).
3. Vollständige Story-by-Story-Abnahme mit zusätzlicher Negativtest-Matrix.
4. OpenAPI-Schema/DTO-Feldabgleich automatisiert absichern.
